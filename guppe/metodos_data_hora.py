...
# A linha abaixo cria um objeto datetime que resultará na zero hora do dia seguinte. Hoje é dia 04/09/2023.
# O resultado da linha abaixo foi O backup será realizado às 2023-09-05 00:00:00
manutencao = datetime.datetime.combine((datetime.datetime.now() + datetime.timedelta(days=1)), datetime.time())

print(f'O backup será realizado às {manutencao}')
