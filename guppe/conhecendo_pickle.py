...
with open('animais.pickle', 'rb') as arquivo:
    '''
    A ordem de recuperação dos objetos no arquivp Pickle é fundamental para a correta leitura dos dados. Na linha abaixo, se a ordem gato, cachorro for
    alterada para cachorro, gato as chamadas de métodos não mais funcionam.
    '''
