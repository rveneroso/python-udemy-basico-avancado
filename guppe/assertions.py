...
"""
'''
IMPORTANTE: Se um programa Python for executado com o parâmetro -O, nenhum assertion será validado. Ou seja, todas as suas validações já eram.
'''


def soma_numeros_positivos(a, b):
    # Na linha abaixo, a mensagem que vem depois da vírgula será exibida no caso da condição sendo verificada falhar.
