...
# Os exemplos abaixo mostram que abs funciona também com números complexos.
numero_complexo = 27j
numero_complexo_negativo = -18j
print(f'Imprimindo o abs do número complexo {numero_complexo}: {abs(numero_complexo)}')
print(f'Imprimindo o abs do número complexo {numero_complexo_negativo}: {abs(numero_complexo_negativo)}')
...
# round() -> Retorna um número arredondado para n digito de precisão após a casa decimal. Se a precisão não forinformada retorna o inteiro mais próximo da entrada.
